          ...
          <tbody>
            {providers.map((p, i) => (
              <tr key={p.id} style={{
                ...
                <td style={{ padding: '10px 16px', color: '#475569', fontSize: 12, fontFamily: 'monospace' }}>{p.rut}</td>
                <td style={{ padding: '10px 16px', color: '#475569', fontSize: 12 }}>{p.email ?? '—'}</td>
                <td style={{ padding: '10px 16px', color: '#475569', fontSize: 12 }}>{p.phone ?? '—'}</td>
